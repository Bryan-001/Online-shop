                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="electronics.php">Show Electronics</a>
                            ...
                            <div class="collapse" id="collapseSliders" aria-labelledby="headingSix" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionSliders">
                                        <a class="nav-link" href="showSlider.php">Show Sliders</a>                
                                        <a class="nav-link" href="addSlider.php">Add Sliders</a>                
                                        <a class="nav-link" href="editSlider">Edit Sliders</a>                        
                                </nav>
                            </div>
