					...
					<form method="POST" action="Register.php">
	                 ...
	                 <?php endif ?>
					   ...
					   <div class="mb-3">
					    ...
					    <input type="email" class="form-control" placeholder="Enter valid Email Address" name="email" value="<?php echo $email;?>" pattern="[A-za-z0-9].+@gmail.com"size="30" required>
    ...
    $(document).ready(function () {
       $("#txtPassword_2").keyup(checkPasswordMatch);
			  ...
			  <button name="Register" type="submit" class="btn btn-primary">Register</button>
                        <p> By registering you accept our <a href="terms.php" style="text-decoration:none;">Terms and conditions</a></p> 
