...
<html lang="en">
    ...
    $sql_n = "SELECT * FROM drinks WHERE product_name='$product_name'";
  	...
  	if (mysqli_num_rows($res_u) > 0) {
  	  $product_name_error = "<font color=red>Product Name exists!</font>";
           ...
           $query = "INSERT INTO drinks (product_image,id,product_name,product_description,product_cost) 
      	    	  VALUES ('$product_image','$id','$product_name','$product_description','$product_cost')";
          
           $results = mysqli_query($db, $query);
           echo "<script> ('Product Sucessfully Added'); window.location='showDrinks.php'
           </script>";
     exit();
  	}
        }
