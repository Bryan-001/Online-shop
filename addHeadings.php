...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add Card Heading</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Card Heading</li>
                        </ol>
                        <div class="row">
				<div class="col-4">
				...
				<div class="col-6">
					<form method="POST" enctype="multipart/form-data" action="">
					  ...
					  <div class="mb-3">
					    <label for="exampleInputEmail1" class="form-label">Card Category</label>
					    <input type="text" class="form-control" name="card_category">
					  </div>

					   <div class="mb-3">
					    <label for="exampleInputEmail1" class="form-label">Card Title</label>
					    <input type="text" class="form-control" name="card_title">
					  </div>
    ...
    $sql_n = "SELECT * FROM cardheading WHERE card_category='$card_category'";
      
  	$res_u = mysqli_query($db, $sql_n);

  	if (mysqli_num_rows($res_u) > 0) {
  	  $card_category_error = "<font color=red>Card Category exists!</font>";
    }
      else{
           $query = "INSERT INTO cardheading (id,card_category,card_title) 
      	    	  VALUES ('$id','$card_category','$card_title')";
          
           $results = mysqli_query($db, $query);
           echo "<script> ('Heading Sucessfully Added'); window.location='showHeadings.php'
           </script>";
     exit();
  	}
        }
