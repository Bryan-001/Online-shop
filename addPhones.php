...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add Phones & Tablets</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add Phones & Tablets</li>
                        </ol>
                        <div class="row">
				<div class="col-4">
    ...
    $sql_n = "SELECT * FROM phones WHERE product_name='$product_name'";
  	...
  	if (mysqli_num_rows($res_u) > 0) {
  	  $product_name_error = "<font color=red>Product Name exists!</font>";
           ...
           $query = "INSERT INTO phones (product_image,id,product_name,product_description,product_cost) 
      	    	  VALUES ('$product_image','$id','$product_name','$product_description','$product_cost')";
          
           $results = mysqli_query($db, $query);
           echo "<script> ('Product Sucessfully Added'); window.location='showPhones.php'
           </script>";
     exit();
  	}
        }
