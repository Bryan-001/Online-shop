...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Computers & Computer Accesories</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Computers & Computer Accesories</li>
                        </ol>
            	<div class="container">
			...
			//select
			$sql = "SELECT * FROM computers WHERE id=$productId";
			//connection
			require('connect.php');
			...
			<?php
				...
				if (isset($_POST['save'])) {
					...
					//INSERT query Values ???
					$sql = "UPDATE  computers SET image=?, id=?,name=?,description=?,cost=? WHERE id=$productId";
					...
					if ($stmt = mysqli_prepare($db,$sql)) {
						...
						if (mysqli_stmt_execute($stmt)) {
							...
							header("location:showComputers.php");
						}else{
