...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Drinks</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Drinks</li>
                        </ol>
            	<div class="container">
			...
			//select
			$sql = "SELECT * FROM drinks WHERE id=$productId";
			//connection
			require('connect.php');
			...
			<?php
				...
				if (isset($_POST['save'])) {
					...
					//INSERT query Values ???
					$sql = "UPDATE  drinks SET image=?, id=?,name=?,description=?,cost=? WHERE id=$productId";
