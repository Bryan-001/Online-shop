        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Phones & Tablets</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Phones $ Tablets</li>
                        </ol>
            	<div class="container">
			...
			<?php
				...
				if (isset($_POST['save'])) {
					...
					//INSERT query Values ???
					$sql = "UPDATE  phones SET image=?, id=?,name=?,description=?,cost=? WHERE id=$productId";
