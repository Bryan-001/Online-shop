        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Electronics</h1>
			...
			*/
				...
				if (isset($_POST['save'])) {
					...
					//INSERT query Values ???
					$sql = "UPDATE  product SET image=?,id=?,name=?,description=?,cost=? WHERE name=$product_name";
					...
					if ($stmt = mysqli_prepare($db,$sql)) {
						...
						mysqli_stmt_bind_param($stmt,"sissd",$param_image,$param_id,$param_name,$param_description,$param_cost);
