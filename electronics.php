                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDrinks" aria-expanded="false" aria-controls="collapseDrinks">
                                <div class="sb-nav-link-icon"><i class="fas fa-wime-glass-alt"></i></div>
                                Drinks
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Show Electronics</li>
                        </ol>
		...
		if ($result) {
			...
			if ($rows>0) {
				...
				while($record = mysqli_fetch_assoc($result)){
						...
						echo "<td>
							<a href='editProduct.php?id=".$record['id']."' class='btn btn-primary'>Edit</a>
