...
<html lang="en">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePhones" aria-labelledby="headingFour" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPhones">
                                        ...
                                        <a class="nav-link" href="editDrinks.php">Edit Phones & Tablets</a>                             
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Drinks</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Show Drinks</li>
                        </ol>
	...
	$sql = "SELECT * FROM drinks";
		...
		if ($result) {
			...
			if ($rows>0) {
				...
				while($record = mysqli_fetch_assoc($result)){
						...
						echo "<td>
							<a href='editDrinks.php?id=".$record['id']."' class='btn btn-primary'>Edit</a>
				...
				echo "<h4>No Drinks available</h4>";
			}
		}else{
		...
		if (isset($_POST['delete'])) {
			...
			//
			$sql = "DELETE FROM drinks WHERE id = ".$productId;
