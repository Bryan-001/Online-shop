...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Show Gaming Products</li>
                        </ol>
	...
	$sql = "SELECT * FROM gaming";
		...
		if ($result) {
			...
			if ($rows>0) {
				...
				while($record = mysqli_fetch_assoc($result)){
						...
						echo "<td>
							<a href='editGamingProducts.php?id=".$record['id']."' class='btn btn-primary'>Edit</a>
		...
		if (isset($_POST['delete'])) {
			...
			//
			$sql = "DELETE FROM gaming WHERE id = ".$productId;
