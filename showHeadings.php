...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Card Headings</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Show Card Headings</li>
                        </ol>
	...
	$sql = "SELECT * FROM cardheading";
		...
		if ($result) {
			...
			if ($rows>0) {
				...
				while($record = mysqli_fetch_assoc($result)){
						...
						echo "<td>".$record['card_category']."</td>";
						echo "<td>".$record['card_title']."</td>";
						echo "<td>
							<a href='editHeadings.php?id=".$record['id']."' class='btn btn-primary'>Edit</a>

							<form method='POST' action=''>
							<input type='hidden' value='".$record['id']."'name='cardId'>
				...
				echo "<h4>No Headings available</h4>";
			}
		}else{
		...
		if (isset($_POST['delete'])) {
			...
			//
			$sql = "DELETE FROM cardheading WHERE id = ".$cardId;
