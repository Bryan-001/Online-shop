...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Phones & Tablets</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="Admin.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Show Phones & Tablets</li>
                        </ol>
	...
	$sql = "SELECT * FROM phones";
		...
		if ($result) {
			...
			if ($rows>0) {
				...
				while($record = mysqli_fetch_assoc($result)){
						...
						echo "<td>
							<a href='editPhones.php?id=".$record['id']."' class='btn btn-primary'>Edit</a>
				...
				echo "<h4>No Phones & Tablets available</h4>";
			}
		}else{
		...
		if (isset($_POST['delete'])) {
			...
			//
			$sql = "DELETE FROM phones WHERE id = ".$productId;
